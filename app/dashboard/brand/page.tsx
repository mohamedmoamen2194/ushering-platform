      ...
      <div className={`min-h-screen bg-background ${isRTL ? "font-arabic" : ""}`} dir={isRTL ? "rtl" : "ltr"}>
        ...
        <header className="bg-card shadow-sm border-b border-border">
          <div className="container mx-auto px-2 sm:px-4 md:px-6 lg:px-8 py-4 max-w-4xl flex flex-col items-center">
            {/* Logo */}
            <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-lg overflow-hidden flex items-center justify-center mx-auto mb-2">
              <img src="/logo.svg" alt="logo" className="w-full h-full object-cover" />
            </div>
            {/* Header Text */}
            <div className="text-center mb-2">
              <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-card-foreground">{user.profile?.company_name || user.name}</h1>
              <p className="text-xs sm:text-sm md:text-base text-muted-foreground">
                {language === "ar" ? "لوحة تحكم العلامة التجارية" : "Brand Dashboard"}
              </p>
            </div>
            {/* Header Actions */}
            <div className="flex flex-wrap justify-center items-center gap-1 sm:gap-2 mt-3 w-full">
              <ThemeToggle />
        ...
        <div className="container mx-auto px-2 sm:px-4 py-4 sm:py-8">
          ...
          {/* Quick Actions */}
          <div className="grid grid-cols-1 lg:grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-8">
            <Link href="/dashboard/brand/applications">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                    <div className="sm:col-span-2">
                      ...
                      <div className="relative w-full">
                        <Input
                          ...
                          className="bg-background border-border text-foreground w-full pr-12 h-11 text-base"
                        />
                        <button
                          type="button"
                          aria-label={language === "ar" ? "فتح التقويم" : "Open calendar"}
                          onClick={() => {
                            const el = document.getElementById("start_date") as HTMLInputElement | null
                            if (el) {
                              // Prefer native picker when supported
                              // @ts-ignore
                    ...
                    <div>
                      ...
                      <div className="relative w-full">
                        ...
                        <button
                          type="button"
                          aria-label={language === "ar" ? "فتح اختيار الوقت" : "Open time picker"}
                          onClick={() => {
                            const el = document.getElementById("start_datetime") as HTMLInputElement | null
                            if (el) {
                              // @ts-ignore
                              if (typeof el.showPicker === "function") {
                                // @ts-ignore
                    ...
                    <div className="sm:col-span-2">
                      ...
                      <div className="relative w-full">
                        ...
                        <button
                          ...
                          aria-label={language === "ar" ? "فتح التقويم" : "Open calendar"}
                          onClick={() => {
                            const el = document.getElementById("end_date") as HTMLInputElement | null
                            if (el) {
                              // @ts-ignore
                              if (typeof el.showPicker === "function") {
                                // @ts-ignore
              ...
              <div className="grid gap-6">
                {gigs.map((gig: any) => (
                  <Card key={gig.id} className="bg-card border-border">
                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 text-sm mb-4">
                        <div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 mt-4 pt-4 border-t">
                        ...
                        {(gig.status === 'active' || gig.status === 'completed') && gig.approved_ushers > 0 && (
