-- Run QR code system updates
-- Execute this script to add QR code functionality to your database
...
-- Update existing shifts to have proper attendance status
UPDATE shifts 
SET attendance_status = CASE 
  WHEN check_in_time IS NOT NULL AND check_out_time IS NOT NULL THEN 'completed'
  WHEN check_in_time IS NOT NULL THEN 'checked_in'
  ELSE 'pending'
END
